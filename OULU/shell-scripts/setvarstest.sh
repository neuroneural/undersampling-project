...
export PATHS_FILE=/data/users2/jwardell1/undersampling-project/OULU/txt-files/paths_graphs
...
#python /data/users2/jwardell1/undersampling-project/OULU/python-scripts/poly_noise1.py $snr $graph_filepath $graph_no
